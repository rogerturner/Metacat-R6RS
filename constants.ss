...
;; bug workaround: changed "grey85" to "black". for some reason on
;; mac osx 10.6, set-background-color! seems to affect the menu font
;; *foreground* color instead of the background color, and grey85 is
;; not very visible as a foreground color.
(define %gui-menu-background-color% (swl-color "black")) ;; was grey85
